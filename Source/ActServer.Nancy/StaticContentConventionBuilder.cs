...
namespace RainbowMage.ActServer.Nancy
{
    ...
    public class StaticContentConventionBuilder
    {
        ...
        /// <param name="allowRootMapping"></param>
        ...
        public static Func<NancyContext, string, Response> AddDirectory(string requestedPath, string contentPath = null, bool allowRootMapping = false, params string[] allowedExtensions)
        {
            ...
            return (ctx, root) =>
            {
                ...
                if (contentPath.Equals("/") && !allowRootMapping)
                {
